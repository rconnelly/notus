...
pub const APP_NAME: &str = "synto";
pub const APP_DISPLAY_NAME: &str = "Synto";
pub const CLI_NAME: &str = "synto";
pub const PACKAGE_NAME: &str = "synto";
pub const VERSION: &str = env!("CARGO_PKG_VERSION");

pub const CONFIG_FILE_NAME: &str = "synto.toml";
pub const LEGACY_CONFIG_FILE_NAME: &str = "wiki.toml";
pub const APP_DIR_NAME: &str = ".synto";
pub const LEGACY_APP_DIR_NAME: &str = ".olw";
pub const VAULT_ENV_VAR: &str = "SYNTO_VAULT";
pub const API_KEY_ENV_VAR: &str = "SYNTO_API_KEY";
pub const AUTO_COMMIT_PREFIX: &str = "[synto]";
...
pub fn effective_app_dir(vault: &Path) -> PathBuf {
    let path = app_dir(vault);
    if path.exists() {
        path
    } else {
        legacy_app_dir(vault)
    }
}

pub fn is_legacy_vault(vault: &Path) -> bool {
    legacy_config_path(vault).exists() && !config_path(vault).exists()
}
